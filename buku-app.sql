...
ALTER TABLE `bukus`
  ...
  ADD KEY `bukus_penulis_id_foreign` (`penulis_id`);
...
ALTER TABLE `bukus`
  ...
  ADD CONSTRAINT `bukus_penulis_id_foreign` FOREIGN KEY (`penulis_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;
COMMIT;
